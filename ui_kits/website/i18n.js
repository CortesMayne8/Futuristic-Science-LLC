...
Handle in accordance with institutional safety guidelines and standard laboratory practice. This product is a research chemical — not a drug, food, or cosmetic.`,
      ...
      'co.payIntro': 'After placing your order, you’ll complete payment using Zelle, Venmo, or Cash App. Due to payment-processor restrictions in the research industry, we use trusted direct payment methods for a more reliable checkout experience. Payment instructions are shown after checkout.',
...
Manipular conforme a las pautas de seguridad institucionales y la práctica estándar de laboratorio. Este producto es un químico de investigación, no un fármaco, alimento ni cosmético.`,
      ...
      'co.placedTitle': '¡Pedido recibido!',
      ...
      'lp.terms.sec': [
        ['Elegibilidad', 'Debe tener al menos 18 años para usar los Servicios. Al usarlos, declara que cumple con este requisito de edad y que es un comprador calificado que actúa con fines legítimos de investigación.'],
        ['Uso de los Servicios', 'Nuestros productos se suministran únicamente para uso en investigación de laboratorio. No están destinados al uso o consumo personal, ni a diagnosticar, tratar, curar o prevenir ninguna enfermedad. Usted acepta usar los Servicios y productos cumpliendo con todas las leyes y regulaciones aplicables. {company} se reserva el derecho de rechazar una venta cuando considere que un cliente está infringiendo estos Términos.'],
        ['Propiedad Intelectual', 'Todo el contenido, logotipos, gráficos, imágenes y demás material de los Servicios es propiedad intelectual de {company} y está protegido por las leyes de derechos de autor y marcas registradas. Se prohíbe el uso no autorizado.'],
        ['Pedidos y Pagos', 'Usted acepta proporcionar información de compra y de cuenta actual, completa y precisa para cada pedido. También acepta mantener actualizados los datos de su cuenta y pago — incluido el correo, el método de pago y la fecha de vencimiento de la tarjeta — para que podamos procesar sus transacciones y contactarlo cuando sea necesario.'],
        ['Aceptación y Cancelación de Pedidos', '{company} se reserva el derecho, a su entera discreción, de rechazar, limitar, cancelar o terminar cualquier pedido en cualquier momento y por cualquier motivo — incluido sospecha de fraude, uso indebido, violaciones de políticas, problemas de disponibilidad, errores de precio o de listado, o preocupaciones regulatorias. Si un pedido se cancela después de recibir el pago, podrá emitirse un reembolso a nuestra discreción conforme a estas políticas.'],
        ['Reembolsos y Devoluciones', ['Debido a la naturaleza sensible de nuestros productos y a los requisitos regulatorios aplicables, todas las ventas son finales.', '{company} no acepta devoluciones, no emite reembolsos ni permite cancelaciones una vez realizado un pedido, independientemente del estado de entrega, salvo cuando lo exija la ley aplicable o según lo dispuesto en nuestras políticas.', 'Nada en estos Términos limita cualquier recurso que la ley aplicable nos obligue a brindar — por ejemplo, cuando enviamos el artículo equivocado, un artículo nunca se envió, o un producto llegó dañado debido a nuestro manejo o embalaje.']],
        ['Paquetes Entregados', ['Una vez que el transportista marca un envío como “Entregado”, la responsabilidad del paquete se transfiere al cliente.', '{company} no se hace responsable de paquetes perdidos o robados después de la entrega — incluido el robo en porches, salas de correo, recepciones, casilleros u otros lugares. No se emitirán reembolsos, créditos ni reemplazos por paquetes confirmados como entregados por el transportista.']],
        ['Daños de Envío o Errores de Preparación', ['En caso de un error verificado de preparación o envío de {company} — como artículos incorrectos, artículos faltantes o daños ocurridos en tránsito antes de la entrega — debe notificarnos dentro de los siete (7) días calendario posteriores a la fecha de entrega del transportista.', 'Este plazo de notificación es firme. Las solicitudes presentadas fuera de este período serán denegadas sin excepción.']],
        ['Documentación Requerida', ['Todas las reclamaciones deben incluir documentación completa y verificable:', ['Un video completo del desembalaje grabado desde el momento en que se abre el paquete por primera vez', 'Fotos del embalaje externo', 'Fotos del contenido del paquete', 'Fotos del albarán incluido con el pedido'], 'Las reclamaciones presentadas sin toda la documentación requerida serán denegadas.']],
        ['Resolución', ['Tras la confirmación de un error elegíble de envío o preparación causado por {company}, podemos, a nuestra entera discreción, emitir un reemplazo de los artículos afectados.', 'No se garantizan reembolsos en efectivo, créditos en tienda ni compensaciones alternativas, y no se proporcionan para paquetes entregados, rechazados o robados.']],
        ['Contracargos', 'Los contracargos presentados por paquetes entregados, rechazados o robados serán disputados utilizando la confirmación del transportista, los registros de entrega y la aceptación de estos Términos por parte del cliente.'],
        ...
        ['Limitación de Responsabilidad', 'En la máxima medida permitida por la ley, {company} no será responsable de daños indirectos, incidentales o consecuentes que surjan del uso — o la imposibilidad de uso — de los Servicios o de cualquier producto adquirido a través de ellos.'],
        ['Detección de Fraude y Verificación', ['Para proteger a nuestros clientes y a nuestro negocio, {company} se reserva el derecho, a su entera discreción, de:', ['Verificar la identidad de cualquier cliente', 'Solicitar identificación o documentación adicional para pedidos marcados como sospechosos o de alto valor', 'Rechazar, retener o cancelar cualquier pedido que razonablemente consideremos fraudulento, no autorizado o no conforme'], 'Los pedidos pueden retenerse hasta completar la verificación.']],
        ['Preparación y Procesamiento', ['Los pedidos se procesan después de recibir y verificar el pago. {company} puede retrasar o cancelar un pedido si:', ['La verificación del pago o la dirección (incluidos AVS/CVV) falla o no es concluyente', 'Se sospecha fraude', 'Surgen problemas de inventario o suministro', 'Surgen preocupaciones regulatorias o de cumplimiento'], 'Cuando un pedido se cancela antes de su preparación, se reembolsará cualquier monto cobrado por ese pedido.']],
        ['Inspección de los Envíos', 'Los clientes deben inspeccionar todos los envíos de inmediato al recibirlos. Cualquier reclamo por un error de envío o preparación debe presentarse dentro del plazo indicado anteriormente, junto con la documentación requerida. La inspección oportuna ayuda a garantizar que los reclamos puedan verificarse y resolverse.'],
        ['Ley Aplicable y Jurisdicción', 'Estos Términos se rigen por las leyes del Estado de Wisconsin, sin tener en cuenta sus principios de conflicto de leyes. Cualquier disputa que surja de o se relacione con estos Términos o los Servicios se presentará exclusivamente en los tribunales estatales o federales ubicados en Wisconsin, y usted consiente la jurisdicción personal de dichos tribunales.'],
        ...
        ['Fuerza Mayor', '{company} no se hace responsable de ningún retraso o incumplimiento que resulte de causas fuera de su control razonable, incluidas, entre otras, interrupciones del transportista, desastres naturales, actos de gobierno, conflictos laborales o interrupciones de la cadena de suministro.'],
        ['Divisibilidad', 'Si alguna disposición de estos Términos se considera inválida o inaplicable, dicha disposición se limitará o eliminará en la medida mínima necesaria, y las disposiciones restantes permanecerán en pleno vigor y efecto.'],
        ['Cambios en los Términos', 'Podemos modificar estos Términos en cualquier momento. Su uso continuado de los Servicios después de publicarse los cambios constituye la aceptación de dichos cambios.'],
        ['Contáctenos', '¿Preguntas sobre estos Términos? Escriba a nuestro equipo a {email}. Al usar los Servicios, usted acepta estos Términos; si no está de acuerdo con alguna parte, debe dejar de usar los Servicios.'],
      ],
      'ruo.eyebrow': 'Legal',
